...
public interface IAuditMappingReportDSMTLinkService extends IDSMTLinkService {
    ...
    public DSMTLinkHelperAppInfo processScopeIssuesFromAMR(DSMTLinkHelperAppInfo dsmtLinkHelperInfo)
    		throws Exception;
    
    public DataGridInfo getAncestorIssues(DSMTLinkHelperAppInfo dsmtLinkHelperInfo)
            throws Exception;
