...
/**
 * <P>
 * This class represents a single column in the AG Data Grid. The class contains information on 1. If the column is
 * hidden or not 2. The name of the column that will be used by the AG Grid (field) 3. The display name of the column
 * that will be in the AG Grid.
 * </P>
 * 
 ...
 */
public class GridDataHeaderColumnInfo implements Serializable {
    ...
    public String toString() {
        ...
        return "GridDataHeaderColumnInfo [hide=" + hide + ", field=" + field + ", headerName=" + headerName + "]";
    }
}
