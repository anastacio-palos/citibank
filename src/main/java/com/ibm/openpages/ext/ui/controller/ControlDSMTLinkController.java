...
import static com.ibm.openpages.ext.ui.constant.ControlDSMTLinkConstants.CONTROL_STATUS_FIELD;
import static com.ibm.openpages.ext.ui.constant.ControlDSMTLinkConstants.DSMT_LINK_CONTROL_CONTROLLER_LOG_FILE_NAME;
...
@Controller
@RequestMapping(value = "jspview/controlDsmtLinkApp")
public class ControlDSMTLinkController extends DSMTLinkBaseController {

    @Autowired
    IControlDSMTLinkService controlService;
    ...
    public void initController() {
        ...
        logger = loggerUtil.getExtLogger(DSMT_LINK_CONTROL_CONTROLLER_LOG_FILE_NAME);
    }
    ...
    public @ResponseBody DSMTLinkHelperAppInfo getInitialPageForApp(@RequestParam("resourceId") String objectId,
        ...
        logger.info("Control DSMT Link Helper Init Start");
        ...
        try
        {
            ...
            dsmtLinkHelperInfo = setupHelperObjectInfo(objectId, CONTROL_STATUS_FIELD);
            dsmtLinkHelperInfo = setupHelperObjectScopeInfo(dsmtLinkHelperInfo, CONTROL_SCOPE_FIELD);

            controlService.getHelperHeaderInfo(dsmtLinkHelperInfo);
            controlService.getLandingPageInfo(dsmtLinkHelperInfo);
        }
        catch (Exception ex)
        {
        ...
        logger.info("Contorl DSMT Link Helper Information before setting it in session: " + dsmtLinkHelperInfo);
         ...
         */
        logger.info("Control DSMT Link Helper Init End");
        return dsmtLinkHelperInfo;
    }

    /**
     * <P>
     * This method get the existing DSMT Links under the Control
     * </P>
     *
     * @param  model
     *                       - Model model
    ...
    public @ResponseBody DataGridInfo getExistingDSMTLinks(Model model, HttpSession session, HttpServletRequest request,
        ...
        try
        {
            ...
            existingDSMTLinksGridInfo = controlService.getExistingDSMTLinks(dsmtLinkHelperInfo);
        }
        catch (Exception ex)
        {
    ...
    public @ResponseBody DataGridInfo getAvailableDSMTLinks(Model model, HttpSession session,
        ...
        try
        {
            ...
            /* Initialize Variables */
            dsmtLinkHelperInfo = (DSMTLinkHelperAppInfo) session.getAttribute(DSMT_LINK_APP_INFORMATION);
            availableDSMTLinks = controlService.getAvailableDSMTLinks(dsmtLinkHelperInfo);
        }
        catch (Exception ex)
        {
    ...
    public @ResponseBody List<DSMTLinkObjectInfo> associateDSMTLinks(
        ...
        try
        {
            ...
            dsmtLinkUpdateFailInfo = controlService.associateDSMTLinks(dsmtLinkHelperInfo);
        }
        catch (Exception ex)
        {
    ...
    public @ResponseBody List<DSMTLinkObjectInfo> rescopeDSMTLinks(
        ...
        try
        {
            ...
            dsmtLinkHelperInfo.setUpdateDsmtLinkInfo(dsmtLinkUpdateInfo);
            dsmtLinkUpdateFailInfo = controlService.rescopeDSMTLinks(dsmtLinkHelperInfo);
        }
        catch (Exception ex)
        {
    ...
    public @ResponseBody List<DSMTLinkObjectInfo> descopeExistingDSMTLinks(
        ...
        try
        {
            ...
            dsmtLinkHelperInfo.setUpdateDsmtLinkInfo(dsmtLinkUpdateInfo);
            dsmtLinkUpdateFailInfo = controlService.descopeDSMTLinks(dsmtLinkHelperInfo);
        }
        catch (Exception ex)
        {
