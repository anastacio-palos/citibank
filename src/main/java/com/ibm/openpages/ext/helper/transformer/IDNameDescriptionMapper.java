...
public class IDNameDescriptionMapper implements Function<ITabularResultSet, Object> {

    private Log log;
    private IFieldUtil fieldUtil;

    public IDNameDescriptionMapper(IFieldUtil fieldUtil, ILoggerUtil iLoggerUtil) {
