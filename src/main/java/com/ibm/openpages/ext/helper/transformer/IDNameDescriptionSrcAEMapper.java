...
public class IDNameDescriptionSrcAEMapper implements Function<ITabularResultSet, Object> {

    private Log log;
    private IFieldUtil fieldUtil;

    public IDNameDescriptionSrcAEMapper(IFieldUtil fieldUtil, ILoggerUtil iLoggerUtil) {
    ...
    public Object apply(final ITabularResultSet iResultSetRows) {
        ...
        log.info("result set for processing=" + resultSet.estimateSize());
