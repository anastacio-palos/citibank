...
public class HelloWorkFlow extends BaseWorkflowCustomAction {

    private static final String CUSTOM_ACTION_SAVE_RESOURCE = "Save Resource";
    private Logger logger = LogManager.getLogger(HelloWorkFlow.class);

    private IGRCObject igrcObject;

    public HelloWorkFlow(IWFOperationContext context, List<IWFCustomProperty> properties) {
