...
public class SetCurrentDateHandler extends DefaultEventHandler {
    ...
    //private static final Logger logger = (Logger) LogManager.getLogger(SetCurrentDateHandler.class);
    ...
    public boolean handleEvent(CreateResourceEvent event) {
    	System.out.println("--> class: SetCurrentDateHandler --> Metodo: handleEvent --> CreateResourceEvent " + event.getTriggerEventType() ); 
    ...
    public boolean handleEvent(UpdateResourceEvent event) {
    	System.out.println("--> class: SetCurrentDateHandler --> Metodo: handleEvent --> UpdateResourceEvent " + event.getTriggerEventType()); 
        IGRCObject object = (IGRCObject)event.getResource();
        setCurrentDate(object);
        return true;
    }
    ...
    private void setCurrentDate(IGRCObject object) {
    	System.out.println("--> class: SetCurrentDateHandler --> Metodo: setCurrentDate --> IGRCObject " + object.toString() ); 
