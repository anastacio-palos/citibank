...
import com.ibm.openpages.api.trigger.ext.TriggerRuleUtil;
...
public class FieldsMatchRule extends DefaultRule {
   ...
   // private static Logger logger = LoggerFactory.getLoggerFactory().getSimpleLogger();
    //private static final Logger logger = (Logger) LogManager.getLogger(FieldsMatchRule.class);
    ...
    private static class RuleEvaluator {
    	 ...
    	 //private static Logger logger = LoggerFactory.getLoggerFactory().getSimpleLogger();
    	 //private static final Logger logger = (Logger) LogManager.getLogger(RuleEvaluator.class);

        static boolean evaluate(final IField field, 
                final String operator, 
                final Object inputValue) {
        	
        	System.out.println("--> class: FieldsMatchRule --> Metodo: RuleEvaluator --> " + " " + "operator: " + operator + " Object: " + inputValue.toString());
        ...
        private static boolean checkEquals(final IField field,
                final Object value1, 
                final Object value2) {
        	System.out.println("--> class: FieldsMatchRule --> Metodo: checkEquals ");
        ...
        private static boolean checkNotEqual(final IField field,
                final Object value1, 
                final Object value2) {
        	System.out.println("--> class: FieldsMatchRule --> Metodo: checkNotEqual ");
        ...
        private static boolean checkLessThan(final IField field,
                final Object value1, 
                final Object value2) {
        	System.out.println("--> class: FieldsMatchRule --> Metodo: checkLessThan ");
            // check null value
            if (field instanceof IStringField) {
                if (isNullOrEmpty(value1) && isNullOrEmpty(value2)) {
                    return false;
        ...
        private static boolean checkLessThanEqualTo(final IField field,
                final Object value1, 
                final Object value2) {
        	System.out.println("--> class: FieldsMatchRule --> Metodo: checkLessThanEqualTo ");
        ...
        private static boolean checkCreaterThan(final IField field,
                ...
                final Object value2) {
            // check null value
        	System.out.println("--> class: FieldsMatchRule --> Metodo: checkCreaterThan ");
            if (field instanceof IStringField) {
                if (isNullOrEmpty(value1) && isNullOrEmpty(value2)) {
                    return false;
                } else if (isNullOrEmpty(value1) && !isNullOrEmpty(value2) ) {
        ...
        private static boolean checkCreateThanEqualTo(final IField field,
                final Object value1, 
                final Object value2) {
        	System.out.println("--> class: FieldsMatchRule --> Metodo: checkCreateThanEqualTo ");
        ...
        private static boolean checkEqualsForMultipleEnum(final List<IEnumValue> value1, final String[] value2) {
        	System.out.println("--> class: FieldsMatchRule --> Metodo: checkEqualsForMultipleEnum ");
        ...
        private static Date parseDate(final String value) {
        	System.out.println("--> class: FieldsMatchRule --> Metodo: parseDate ");
            try {
        ...
        private static Object getFieldValue(final IField field) {
        	System.out.println("--> class: FieldsMatchRule --> Metodo: getFieldValue ");
            if (field.isNull()) {
                return null;
            }
        ...
        static Object getInputFieldValue(final IField field, final String inputValue) {
        	System.out.println("--> class: FieldsMatchRule --> Metodo: getInputFieldValue ");
            if (field instanceof IStringField) {
                return inputValue;
            }
            else if (field instanceof IBooleanField) {
        ...
        private static String[] parseEnum(String inputValue) {
        	System.out.println("--> class: FieldsMatchRule --> Metodo: parseEnum ");
            return inputValue.split(",");
        }
     
        private static boolean isNullOrEmpty(Object s) {
        	System.out.println("--> class: FieldsMatchRule --> Metodo: isNullOrEmpty ");
            if (s == null) {
                return true;
            }
    ...
    private String getAttributeValue(final String attributeName, 
    	...
    	System.out.println("--> class: FieldsMatchRule --> Metodo: getAttributeValue ");
    ...
    private String getRequiredAttributeValue(final String attributeName) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: getRequiredAttributeValue ");
    ...
    private AssociateCheckOnType getAssociateCheckOnType() {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: getAssociateCheckOnType ");
    ...
    private CopyCheckOnType getCopyCheckOnType() {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: getCopyCheckOnType ");
    ...
    private boolean evaluate(AbstractEvent event, List<Id> Ids)
            {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: evaluate --> AbstractEvent 647 ");
    ...
    private boolean evaluate(AbstractEvent event, Id id)
            {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: evaluate --> AbstractEvent");
        IResourceService resourceService = ServiceFactory.getServiceFactory(event.getContext()).createResourceService();
        String contentType = getRequiredAttributeValue(ATTR_CONTENT_TYPE);
        IGRCObject object = resourceService.getGRCObject(id);
    ...
    private boolean evaluate(IGRCObject object, String contentType) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: evaluate --> IGRCObject");
    ...
    private CheckForType getRuleCheckFor() {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: getRuleCheckFor ");
    ...
    private List<Object[]> getRules(IGRCObject object) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: getRules ");
    ...
    private List<Object[]> getRuleList(Map<String, String> ruleMap, 
            ...
            IGRCObject object) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: getRuleList ");
    ...
    private void validateOperator(IField field, String operator) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: validateOperator ");
    ...
    private String getRuleAttributeIndex(String attribute) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: getRuleAttributeIndex ");
        return attribute.replace(ATTR_RULE_FIELD_PREFIX, "");
    }
    
    private boolean isRuleFieldAttribute(String attribute) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: isRuleFieldAttribute ");
    ...
    public boolean isApplicable(CreateResourceEvent event) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: getCopyCheckOnType --> CreateResourceEvent");
    ...
    public boolean isApplicable(UpdateResourceEvent event) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: getCopyCheckOnType --> UpdateResourceEvent");
        IResource resource = event.getResource();
        if (resource.isFolder()) {
            return false;
        }
    ...
    public boolean isApplicable(AssociateResourceEvent event) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: getCopyCheckOnType  --> AssociateResourceEvent ");
    ...
    public boolean isApplicable(DisassociateResourceEvent event) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: isApplicable  --> AssociateResourceEvent");
        AssociateCheckOnType checkOn = getAssociateCheckOnType();
        List<Id> objectIds = null;
    ...
    public boolean isApplicable(CopyResourceEvent event) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: isApplicable --> CopyResourceEvent");
    ...
    public boolean isApplicable(DeleteResourceEvent event) {
    	System.out.println("--> class: FieldsMatchRule --> Metodo: isApplicable --> DeleteResourceEvent");
