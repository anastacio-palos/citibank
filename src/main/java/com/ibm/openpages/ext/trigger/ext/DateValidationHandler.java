...
public class DateValidationHandler extends DefaultEventHandler {
   ...
   // private static final Logger logger = LogManager.getLogger(ContentTypeMatchRule.class);
    ...
    public boolean handleEvent(CreateResourceEvent event) {
    	System.out.println("-->class: DateValidationHandler --> Metodo: handleEvent --> CreateResourceEvent " + " " + event.getResource() );
    ...
    public boolean handleEvent(UpdateResourceEvent event) {
    	System.out.println("-->class: DateValidationHandler --> Metodo: handleEvent --> UpdateResourceEvent " + " " + event.getResource() );
        IGRCObject object = (IGRCObject)event.getResource();
        if(!validateDateFields(object)) {
            throwException("Start date before end date",
                    Collections.emptyList(),
    ...
    private boolean validateDateFields(IGRCObject object) {
    	System.out.println("-->class: DateValidationHandler --> Metodo: validateDateFields --> IGRCObject " + " " + object.getName());
        ...
        System.out.print("endDate --> " + " " + endDate.toString());
