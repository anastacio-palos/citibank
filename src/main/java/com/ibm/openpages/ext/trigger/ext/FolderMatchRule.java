...
public class FolderMatchRule extends DefaultRule {
   ...
   // private static Logger logger = LoggerFactory.getLoggerFactory().getSimpleLogger();
    ...
    //private static final Logger logger = (Logger) LogManager.getLogger(FolderMatchRule.class);
    
    private String getRequiredAttributeValue(String attributeName) {
    	System.out.println("--> class: FolderMatchRule --> Metodo: getRequiredAttributeValue ");
    ...
    private String getAttributeValue(String attributeName, String defaultValue) {
    	System.out.println("--> class: FolderMatchRule --> Metodo: getAttributeValue ");
    ...
    private AssociateCheckOnType getAssociateCheckOnType() {
    	System.out.println("--> class: FolderMatchRule --> Metodo: getAssociateCheckOnType ");
    ...
    private CopyCheckOnType getCopyCheckOnType() {
    	System.out.println("--> class: FolderMatchRule --> Metodo: getCopyCheckOnType ");
    ...
    private ScopeType getScopeType() {
    	System.out.println("--> class: FolderMatchRule --> Metodo: getScopeType ");
    ...
    private boolean evaluate(IGRCObject grcObject, String folderPath, ScopeType scope) {
    	System.out.println("--> class: FolderMatchRule --> Metodo: evaluate -->  " + folderPath );
    ...
    private boolean evaluateIdList(AbstractEvent event, 
            ...
            String folderPath, 
            ScopeType scope) {
    	System.out.println("--> class: FolderMatchRule --> Metodo: evaluateIdList -->  " + folderPath );
    ...
    public boolean isApplicable(CreateResourceEvent event) {
    	System.out.println("--> class: FolderMatchRule --> Metodo: isApplicable --> CreateResourceEvent " + event.toString() );
    ...
    public boolean isApplicable(UpdateResourceEvent event) {
    	System.out.println("--> class: FolderMatchRule --> Metodo: isApplicable --> UpdateResourceEvent " + event.toString() );
        String folderPath = getRequiredAttributeValue(ATTR_FOLDER_PATH);
        ScopeType scope = getScopeType();
    ...
    public boolean isApplicable(AssociateResourceEvent event) {
    	System.out.println("--> class: FolderMatchRule --> Metodo: isApplicable --> AssociateResourceEvent " + event.toString() ); 
        String folderPath = getRequiredAttributeValue(ATTR_FOLDER_PATH);
        ScopeType scope = getScopeType();
    ...
    public boolean isApplicable(DisassociateResourceEvent event) {
    	System.out.println("--> class: FolderMatchRule --> Metodo: isApplicable --> DisassociateResourceEvent " + event.toString() ); 
        String folderPath = getRequiredAttributeValue(ATTR_FOLDER_PATH);
        ScopeType scope = getScopeType();
        AssociateCheckOnType checkOn = getAssociateCheckOnType();
    ...
    public boolean isApplicable(CopyResourceEvent event) {
    	System.out.println("--> class: FolderMatchRule --> Metodo: isApplicable --> CopyResourceEvent " + event.toString() ); 
        String folderPath = getRequiredAttributeValue(ATTR_FOLDER_PATH);
        ScopeType scope = getScopeType();
    ...
    public boolean isApplicable(DeleteResourceEvent event) {
    	System.out.println("--> class: FolderMatchRule --> Metodo: isApplicable --> DeleteResourceEvent " + event.toString() ); 
