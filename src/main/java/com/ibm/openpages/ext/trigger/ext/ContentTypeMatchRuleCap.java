...
public class ContentTypeMatchRule extends DefaultRule {
    ...
    /**
     * <P>
     * This method initializes the required services for the GRC Object Utilities. This method should be used only when
     * invoking from a trigger. While using helpers the services will be injected into the class via Auto Wiring.
     */

   // private static final Logger logger = LogManager.getLogger(ContentTypeMatchRule.class);
  ...
  // private Logger logger = LoggerFactory.getLoggerFactory().getSimpleLogger();
    ...
    private String getAttributeValue(final String attributeName, 
    	...
    	System.out.println("-->class: ContentTypeMatchRule --> Metodo: getAttributeValue");
    ...
    private String getRequiredAttributeValue(String attributeName) {
    	System.out.println("-->class: ContentTypeMatchRule --> Metodo: getRequiredAttributeValue");
    ...
    private AssociateCheckOnType getAssociateCheckOnType() {
    	...
    	System.out.println("-->class: ContentTypeMatchRule --> Metodo: getAssociateCheckOnType");
    ...
    private CopyCheckOnType getCopyCheckOnType() {
    	System.out.println("-->class: ContentTypeMatchRule --> Metodo: getCopyCheckOnType");
    ...
    private boolean evaluate(IGRCObject object, String contentType) {
    	...
    	System.out.println(" -->class: ContentTypeMatchRule --> Metodo: evaluate --> " + " object: " + object.toString()
    	+ " contentType: " + contentType );
    	System.out.println(" --> IGRCObject");
    	System.out.println(" --> UpdateResourceEvent: " + object.isFolder() + "ContentType: " +contentType );
        System.out.println(" --> Name: " + object.getName());
        System.out.println(" --> Descripcion: " + object.getDescription());
        System.out.println(" --> ID: " + object.getId());
        System.out.println(" --> Path: " + object.getPath());
        System.out.println(" --> Date Modificado: " + object.getModifiedDate());
    ...
    private boolean evaluateIdList(AbstractEvent event,
            List<Id> objectIds,
            String contentType) {
    	System.out.println("--> class: ContentTypeMatchRule --> Metodo: evaluateIdList " +  " contentType: " + contentType);
    ...
    public boolean isApplicable(CreateResourceEvent event) {
        System.out.println("class --> ContentTypeMatchRule --> Metodo: isApplicable -->  CreateResourceEvent: " + event.getResource());
        System.out.println("Demo AMS" + event.getResource());
        String contentType = getRequiredAttributeValue(ATTR_CONTENT_TYPE);
        IResource resource = event.getResource();
        if (resource.isFolder()) {
        	System.out.println("into if --> CreateResourceEvent: " + resource.isFolder() + " " + "ContentType: " +contentType);
            return false;
        }
        System.out.println(" --> CreateResourceEvent: " + resource.isFolder() + "ContentType: " +contentType );
        System.out.println(" Name: " + resource.getName());
        System.out.println(" Descripcion: " + resource.getDescription());
        System.out.println(" ID: " + resource.getId());
        System.out.println(" Path: " + resource.getPath());
        System.out.println(" Date Modificado: " + resource.getModifiedDate());
    ...
    public boolean isApplicable(UpdateResourceEvent event) {
    	/*
    	System.out.println("class --> ContentTypeMatchRule --> Metodo: isApplicable -->  UpdateResourceEvent: " + event.getResource().toString());

        String contentType = getRequiredAttributeValue(ATTR_CONTENT_TYPE);
        IResource resource = event.getResource();
        if (resource.isFolder()) {
        	System.out.println("UpdateResourceEvent: " + resource.isFolder() + "ContentType: " +contentType);
            return false;
        }
        System.out.println("UpdateResourceEvent: " + resource.isFolder() + "ContentType: " +contentType );
        System.out.println(" Name: " + resource.getName());
        ...
        return true;//evaluate((IGRCObject) resource, contentType);
    ...
    public boolean isApplicable(AssociateResourceEvent event) {
    	System.out.println("class --> ContentTypeMatchRule --> Metodo: isApplicable -->  AssociateResourceEvent: " + event);
    	System.out.println("isApplicable ContentTypeMatchRule: " + event + "contentType: " + ATTR_CONTENT_TYPE);
        String contentType = getRequiredAttributeValue(ATTR_CONTENT_TYPE);
    ...
    public boolean isApplicable(DisassociateResourceEvent event) {
    	System.out.println("class --> ContentTypeMatchRule --> Metodo: isApplicable -->  DisassociateResourceEvent: " + event);
        String contentType = getRequiredAttributeValue(ATTR_CONTENT_TYPE);
        AssociateCheckOnType checkOn = getAssociateCheckOnType();
    ...
    public boolean isApplicable(CopyResourceEvent event) {
    	System.out.println("class --> ContentTypeMatchRule --> Metodo: isApplicable -->  CopyResourceEvent: " + event);
        String contentType = getRequiredAttributeValue(ATTR_CONTENT_TYPE);
    ...
    public boolean isApplicable(DeleteResourceEvent event) {
    	System.out.println("class --> ContentTypeMatchRule --> Metodo: isApplicable -->  DeleteResourceEvent: " + event);
